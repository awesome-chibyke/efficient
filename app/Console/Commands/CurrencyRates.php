...
class CurrencyRates extends Command
{
     ...
     * @return void
     */
    public function __construct(InvestmentSettings $investmentSettings, InvestmentStore $investmentStore, \App\Models\AppSettings $appSettings, CurrencyRatesModel $currencyRatesModel)
    {
        parent::__construct();
