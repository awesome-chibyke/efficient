                    ...
                    <tr>
                        <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <h4 style="font-family: sans-serif; font-size: 18px; font-weight: normal; margin: 0; margin-bottom: 15px; text-align: center; color:#800080;">Referral Report</h4>
                                ...
                                <tr>
                                    ...
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi {{$ReferrerUserDetails->name}},</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">You have successfully referred {{$referredInvestmentDetails->UserDetails->name}} to join our {{$referredInvestmentDetails->InvestmentPlan->name_of_plan}}.</p>

                                        @php $totalReferrals = $referrerInvestmentDetails->getAllReferralForAnInvestment($referrerInvestmentDetails->referral_id) @endphp
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">This makes the total number of referrals you have on this investment : {{$totalReferrals->count()}}</p>
                                        <hr>

                                        @php $amountForReferrer = auth()->user()->getAmountForView($referrerInvestmentDetails->InvestmentPlan->amount_for_referral) @endphp
                                        @if(count($totalReferrals) == 1)
                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><span> You have successfully referred </span><strong> {{$totalReferrals->count()}} </strong> <span> person to this investment. you need to refer  {{$referrerInvestmentDetails->InvestmentPlan->maximum_no_of_referral - $totalReferrals->count()}} more person to be eligible for a cash reward of ({{$amountForReferrer['data']['currency']}}) {{number_format($amountForReferrer['data']['amount'])}} after {{$referrerInvestmentDetails->InvestmentPlan->duration_for_referral_reward}} days from inception of this investment</span></p>
                                        @endif

                                        @if(count($totalReferrals) == 2)
                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><span> You have successfully referred </span><strong> {{$totalReferrals->count()}} </strong> <span> persons to this investment.  You are now eligible for a cash reward of ({{$amountForReferrer['data']['currency']}}) {{number_format($amountForReferrer['data']['amount'])}} after {{$referrerInvestmentDetails->InvestmentPlan->duration_for_referral_reward}} days from inception of this investment</span></p>
                                        @endif
