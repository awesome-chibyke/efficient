    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-18">Due Investments</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="/home">Home</a></li>
                            <li class="breadcrumb-item active">Due Investments</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 box-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="text-danger"><b>Due Investments</b> <div class="pull-right">  @if(auth()->user()->type_of_user === 'admin') <a title="Please select transaction to be confirmed and then click this button to confirm" href="javascript:;" onclick="confirmDispensation(this)" class="btn btn-info guoBtn">confirm Dispensation of Reward</a> @endif </div> </h4>
                        <div>
                            <form action="{{route('show_investments_by_date', [$investmentSettings->unique_id, 'due'])}}" method="post">
                                @csrf
