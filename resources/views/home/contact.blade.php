                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="contact-info-box">
                            ...
                            <h3>Our Address</h3>
                            <p>Head Office: <?php print $siteAddress;?></p>
                            <p>Head Office Annex: <?php print $siteAddress3;?></p>
                            <p>Head Office Annex: <?php print $siteAddress4;?></p>
                            <p>Branch Office: <?php print $siteAddress1;?></p>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="contact-image" data-tilt>
                            <img src="{{asset('main/assets/img/contact.png')}}" alt="image">
                        </div>
                    </div>
