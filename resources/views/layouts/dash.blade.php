...
<script src="{{asset('dash_assets/assets/js/init/weather-init.js')}}"></script>


<script src="{{asset('dash_assets/assets/js/init/fullcalendar-init.js')}}"></script>
...
<!--datatables-->
@php $dataTablePages = ['view_all_roles', 'all_user_type', 'add_role_for_user', 'wallet']; @endphp
...
@php $pageErrorArray = ['show_top_up_transactions', 'main_settings_page', 'settings_page', 'editProfile', 'wallet', 'investments_settings', 'create_gallery_view', 'compose', 'add_funds', 'login_authenticator'];  @endphp
