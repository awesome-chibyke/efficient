        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 offset-2">
                <div class="login-form">
                    ...
                    <form method="post" action="{{ route('login-admin-user') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="email" value="{{old('user_email')}}" name="user_email" class="form-control" placeholder="Email Address">
                            @error('email')
