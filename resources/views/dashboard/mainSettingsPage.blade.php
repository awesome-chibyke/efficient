                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <form id="contactForm" method="post" action="{{ route('app_settings_sub', [$appSettings->unique_id]) }}" class="log-form">
                                        ...
                                        <hr>
                                        <div>
                                            <h3 style="color:white;">Bank Section</h3>
                                        </div>
                                        ...
                                        @if(count($allBanks) > 0)
                                            ...
                                            @foreach($allBanks as $kk => $eachBankeDetails)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select onchange="dropBankName(this)" id="bank_code" name="bank_code[]" class="bank_code form-control @error('bank_code') is-invalid @enderror" data-bank-code="{{$eachBankeDetails->bank_code}}" onload="fillBankDetails(this)"  >
                                                    ...
                                                    @if($errors->has('bank_code.*'))
                                                        <span class="invalid-feedback" role="alert">
                                                            @foreach($errors->get('bank_code.*') as $message)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($errors->has('bank_account_no.*'))
                                                        <span class="invalid-feedback" role="alert">
                                                            @foreach($errors->get('bank_account_no.*') as $message)
                                                                @foreach($message as $error)
                                                                    <strong>{{ $error }}</strong><br>
                                                                @endforeach
                                                            @endforeach
                                        ...
                                        @else
                                            ...
                                            <div class="form-group">
                                                <label for="bank_code" class="control-label">{{ __('Bank Name') }} </label>
                                                <select required onchange="dropBankName(this)" id="bank_code" name="bank_code[]" class="bank_code form-control @error('bank_code') is-invalid @enderror" data-bank-code="" onload="fillBankDetails(this)"  >
