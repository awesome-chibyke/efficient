                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="author-widgets-single res-mg-t-30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <h2 style="color:white;">All Investments</h2>
                            </div>
                            <div class="col-sm-6">
                                @if(auth()->user()->privilegeChecker('confirm_disbursed_incentive'))
                                <div class="pull-right">  <button title="Please tick the check box beside each incentive for an investment and click this btton to confirm its disbursement" href="javascript:;" onclick="ConfirmDisbursedIncentive(this)" class="btn btn-info guoBtn">Confirm Disbursed Incentive(s)</button> </div>
                                @endif
                            </div>
                            <div class="col-sm-12">
                                <p class="alert-info alert">Referral ID are unique for each investment you create, therefore when one uses a referral ID for an investment you created to register for a package on our platform. The referral Reward  only affects the investment that has the referral ID used. Please click the 'Copy Referral Link' to copy your referral Link, Any user you invite to the platform can visit this link and use it to register for an investment package. </p>
                            </div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        @if($eachInvestmentDetails->status === 'active')
                                                            <br>
                                                            <button class="copybtn btn btn-block btn-info" type="button" id="button-addon2"  data-clipboard-target="#refLink2Holder{{$count}}" >Copy Referral Link</button>
                                                        @endif
                                                    </div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div tabindex="-1" aria-hidden="true" role="menu" class="dropdown-menu">
                                                            ...
                                                            @if(auth()->user()->privilegeChecker('edit_user_investment'))
                                                            <button type="button" tabindex="0" class=" btn btn-block"><a href="{{route('edit_investment', [$eachInvestmentDetails->unique_id])}}">Edit Investment</a></button>
                                                            @endif
                                                        </div>
                                                    </div>
